  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-3xl shadow-xl w-[90%] max-w-3xl p-12 relative flex flex-col gap-6"
      >
        <button
          onClick={onClose}
          className="size-20 absolute top-5 right-5 transition hover:scale-125 md:size-6 rotate-45 cursor-pointer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" /></svg>
        </button>
        <h2 className="text-2xl font-semibold text-center">{feature.title.toLocaleUpperCase()}</h2>
